...
function generate_plots(train_folder)
    ...
    figure("name", "Test 1: Trimmed/Normalized Audio");
    hold on
    fig_count = fig_count + 1;
    ...
    figure("name", "Test 3: Mel Filter Bank");
    hold on
    for n=1:20
    ...
    M = 100;
    K = 20;
    mfcc_1 = get_mfcc(y2, fs, N, M, K, false);
    mfcc_2 = get_mfcc(y3, fs, N, M, K, false);
    
    % Plotting the mfcc for two users
    figure("name", "Test 5: MFCC Comparison");
    fig_count = fig_count + 1;
    hold on
